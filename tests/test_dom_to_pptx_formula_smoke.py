...
EXPECTED_PATCH_VERSION = "2026-04-25-gradient-overlay-v14"
...
def test_dom_to_pptx_formula_smoke():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            page.wait_for_function("window.domToPptx && window.runFormulaPptxSmokeTest")
            result = page.evaluate("() => window.runFormulaPptxSmokeTest()")
        finally:
            browser.close()
