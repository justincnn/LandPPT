...
class FileOutlineGenerationRequest(BaseModel):
    ...
    min_pages: Optional[int] = Field(8, ge=5, le=150, description="Minimum pages for custom_range mode")
    max_pages: Optional[int] = Field(15, ge=5, le=150, description="Maximum pages for custom_range mode")
    fixed_pages: Optional[int] = Field(10, ge=5, le=150, description="Fixed page count")
    ppt_style: str = Field("general", description="PPT style: 'general', 'conference', 'custom'")
    custom_style_prompt: Optional[str] = Field(None, description="Custom style prompt")
